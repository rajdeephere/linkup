...
|-------|-------|------------------|--------------|--------|
| [00](./00-single-server-correct-chat.md) | Correct chat on one server | ordered, idempotent, offline-tolerant 1:1 + group chat | 1–6 | ✅ done |
| [01](./01-realtime-ux-receipts-presence.md) | Real-time feel | double-tick receipts, presence, typing, reconnect/sync | 6–7 | ✅ done |
| [02](./02-scale-the-fanout.md) | Scale the fan-out ⭐ | A on pod-1 → B on pod-7; pod-kill zero-loss | 8–9 | ✅ done |
| [03](./03-media-and-push.md) | Media + push | send a photo + voice note; background → push | 10–11 | ✅ done |
| [04](./04-flagship-subsystem.md) | One flagship ⭐ | AI assist (summarize + smart replies + async moderation) | 12–13 | ✅ done |
| [05](./05-deploy-and-productize.md) | Deploy + multi-region | live public URL; trace across pods; (stretch) 2nd region | 14–15 | ⬜ next |
