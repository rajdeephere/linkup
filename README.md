...
| | |
|---|---|
| **Phase** | 0 — *correct chat on one server* (Day 1 of 15 ✅) |
| **Shipped** | JWT auth · `User`/`Device` domain · `/me` · Angular login/home · `SocketService` (stream stub) |
| **Next** | Day 2 — conversations + participants (REST) + conversation-list view |
